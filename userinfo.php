...
<!--             <input type="number" name="limbs" id="limbs" value="<?= $user['limbs'] ?>" min="1" max="4" required> <br/> -->
            <label><input type="radio" checked="checked" name="limbs" id="limbs" value="2">2</label>
            <label><input type="radio" name="limbs" id="limbs" value="4">4</label>
            <label><input type="radio" name="limbs" id="limbs" value="6">6</label>
